...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <!--[if lt IE 7]>
		...
		<div data-role="page" data-url="/_display/" tabindex="0" class="ui-page ui-body-c ui-page-active" style="min-height: 600px;">
    ...
    <div data-role="content" class="ui-content" role="main" style="min-height: 455px;">
        <!-- Inner content -->
	<div id="content1" style="min-height: 230px;">
			<h3>IMPRESSUM</h3>
	...
	<div id="content2" style="min-height: 230px;">
