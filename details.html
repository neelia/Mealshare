...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div data-role="content" class="ui-content" role="main" style="min-height: 455px;">
		...
		<div id="content1">
			...
			<p> am <strong>15.06.2014</strong> <br> um <strong>15:30 Uhr</strong> <br> von <strong>Peter Pan</strong> <br> fuer <strong>4 Personen</strong><br>
			Isst mit: <strong> Rosa Panther, Ella Example, Max Mustermann</strong></p>
		
	
		<input type="submit" class="create_profile" value="Mitessen">
			<p> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, 
			sed diam nonumy eirmod tempor invidunt ut labore <br> et dolore magna aliquyam erat, 
