...
<body>
  ...
  ?>
  <div data-role="page" data-url="/_display/" tabindex="0" class="ui-page ui-body-c ui-page-active detail-page" style="min-height: 550px;">
    <div data-role="header" class="ui-header ui-bar-a" role="banner">
      <div class="header-content clearfix">
        <div class="back-btn-wrapper"><a href="" class="back-btn"></a></div>
        <h1 class="header-headline">Essendetail</h1>
      </div>
    </div>
    <div data-role="content" class="ui-content info-page-content" role="main" style="min-height: 455px;">
     ...
     <div class="meal-wrapper meal-wrapper-accepted clearfix">
      ...
      <div class="meal-wrapper meal-wrapper-offer clearfix">
        ...
        <div class="meal-wrapper clearfix">
          ...
          <div class="cta-wrapper clearfix">
            <a class="btn btn-6 btn-6j" href="details.php">Mitessen</a>
          </div>
          <div class="description-wrapper">
            <p class="description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore 
              et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. 
