...
<body>
      <div data-role="page" data-url="/_display/" tabindex="0" class="ui-page ui-body-c ui-page-active" style="min-height: 550px;">
        <div data-role="header" class="ui-header ui-bar-a" role="banner">
            ...
            <!-- oberer Bereich -->
            <div class="logo"><h1>Mahlzeit hinzuf&uuml;gen</h1></div>
            
      </div>

      <div data-role="content" class="ui-content" role="main" style="min-height: 455px;">  <!-- Inner content -->
          <form method="post" action="?act=addmeal">
               <fieldset>
                    <ul>
                         <li>
                              <label for="title">Was gibt es leckeres zu essen?</label>
